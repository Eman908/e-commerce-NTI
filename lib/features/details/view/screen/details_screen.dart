...
import 'package:e_commerce/features/details/view/widget/actions.dart';
import 'package:e_commerce/features/details/view/widget/price.dart';
import 'package:e_commerce/features/details/view/widget/rating.dart';
...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: homeAppBar(title: StringApp.titleDetails),
      body: Directionality(
